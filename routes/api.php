...
Route::group(['middleware' => ['auth:sanctum', '2fa', 'under_maintenance']], function () {
    ...
    Route::prefix('meetings/{meeting}')->group(function() {
        ...
        Route::post('snapshots', 'MeetingController@addSnapshot');
        Route::get('snapshots', 'MeetingController@getSnapshots');
        Route::delete('snapshots/{uuid}', 'MeetingController@deleteSnapshot');
